...
;; Strongest color (bright green)
     (font-lock-function-name-face ((t (:bold t :foreground "#55ff55"))))
...
;; Strong text highlight 2 (light green)
     (font-lock-type-face ((t (:bold t :foreground "#b9FC6D"))))
...
;; light red
       (font-lock-keyword-face ((t (:bold t :foreground "#ff5555"))))
