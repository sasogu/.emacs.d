...
fonts."
  ...
  (color-theme-install
   '(color-theme-gtk-ide
     ...
     (font-lock-string-face ((t (:italic t :foreground "DarkGreen"))))
     (font-lock-keyword-face ((t (:foreground "Blue"))))
     (font-lock-warning-face ((t (:bold t :foreground "VioletRed"))))
     (font-lock-constant-face ((t (:foreground "OliveDrab"))))
     (font-lock-type-face ((t (:bold t :foreground "Black"))))
     (font-lock-variable-name-face ((t (:foreground "DarkGoldenrod"))))
     (font-lock-function-name-face ((t (:bold t :foreground "Black"))))
  ...
  (color-theme-install
   '(color-theme-midnight
     ((font . "fixed")
      ...
      (cursor-color . "grey85"))
     (default ((t (nil))))
     (font-lock-comment-face ((t (:italic t :foreground "gey60"))))
